...
public class CursoGetRequest {
	...
	public CursoGetRequest() {
		// TODO Auto-generated constructor stub
	}

	public CursoGetRequest(Integer idCurso, String descricao, String qtdAluno, LocalDate dataAbertura,
			LocalDate dataFechamento, Categoria categoria) {
		super();
		IdCurso = idCurso;
